    ...
    render: function() {
        return (
            <div>
                ...
                <ul className="header">
                    <li id="tab"><IndexLink to="/" activeClassName="active">HOME</IndexLink></li>
                    <li id="tab"><Link to="Stuff" activeClassName="active">STUFF</Link></li>
                    <li id="tab"><Link to="Contact" activeClassName="active">CONTACT</Link></li>
                </ul>
